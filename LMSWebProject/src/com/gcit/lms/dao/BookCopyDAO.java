...
public class BookCopyDAO extends BaseDAO<BookCopy> implements Serializable {
	...
	public List<BookCopy> readBooksByBranch(int branchId) throws SQLException{
		  String select = "Select * from tbl_book_copies where branchId=? and noOfCopies>0";
		                     
		 @SuppressWarnings("unchecked")
		List <BookCopy> bookCopies= (List<BookCopy>) read(select,new Object[]{branchId});
		return bookCopies;
